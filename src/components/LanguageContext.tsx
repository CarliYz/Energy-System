...
const DICTIONARY: Record<string, string> = {
  // Menu items
  'Act I · Panoramic Risk Sensing': '第一幕：安全风险全局感知',
  'Act II · Infrastructure Monitoring': '第二幕：基础设施设备监控',
  'Act III · Macro Sentiment': '第三幕：宏观能源宏观舆情监测',
  'Act IV · Enterprise Anomaly Oversight': '第四幕：企业异常运营监管',
  'Act V · Audit & Brief': '第五幕：流程审计与公文分发',
  'Intelligence Modules': '智能研判决策组件',
  'Minister Dashboard': '部长专属决策大屏',
  'National Energy Grid': '国家能源网络设施',
  'Regional Facilities': '区域基础设施监控',
  ...
  'GDP × Capacity Bollinger Band Monitor': 'GDP × 产能 布林域区间监控',
  'GDP TARGET 2026': '2026 年度 GDP 目标',
  'OIL & GAS SHARE': '油气贡献占比',
  'TODAY COMPLIANCE': '今日合规企业数',
  'BREACH': '跌出带宽',
  'AgingEquipment': '设备老化',
  'Strike': '员工罢工',
  'PipelineMaintenance': '管道维修',
  'Weather': '天气因素',
  'OilfieldRepair': '油田维修',
  'Energy Self-Sufficiency': '能源自给率',
  'Today Supply / Demand': '今日产量 / 需求',
  '7-Day Gap Forecast': '未来 7 天供需缺口',
  'Pending Sentiment Cases': '待立案舆情',
  'AI Penetration Insight': 'AI 穿透解读',
  'Energy News Briefing': '能源方向新闻滚动',
  'DOMESTIC': '国内',
  'INTERNATIONAL': '国际',
  'HIGH': '高',
  'MED': '中',
  'LOW': '低',
  'Sentiment Funnel · Today': '今日舆情漏斗',
  'Detail ↗': '详细 ↗',
  '关键设施设备知识库': '关键设施设备知识库',
  '沉淀 30 年老工经验 · 操作手册 · 历史案例 → RAG 知识图谱': '沉淀 30 年老工经验 · 操作手册 · 历史案例 → RAG 知识图谱',
  '数据来源': '数据来源',
  'Agent 吞入': 'Agent 吞入',
  '知识库内容': '知识库内容',
  '知识图谱预览': '知识图谱预览',
  '向知识库提问': '向知识库提问',
  '相关链接': '相关链接',
  'Full Lifecycle Compliance Audit': '全进程合规审查',
  'Compliance': '合规审查',
  'Operations': '项目运营',
  'Procurement': '采购',
  'Tender': '招标',
