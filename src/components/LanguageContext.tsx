...
const DICTIONARY: Record<string, string> = {
  ...
  'National Energy Grid': '国家电能骨干网',
  'Regional Facilities': '区域工业设施监测',
  'Facility Profile': '设施SCADA测点自检',
  'Anomaly Early Warning': '异动早期预警',
  'Pipeline Time-Series': '管线时序多维分析',
  'Enterprise Reporting': '多口径数据核对',
  'Auto Attribution': '合规行为自动归因',
  'Workflow Attribution': '多智能体研判流',
  'Knowledge Graph Mining': '里海利益链层级深度挖掘',
  'Full-Chain Audit': '全链条数字审计',
  'Life-Cycle Audit Trail': '多维行动与流程泳道图',
  'Report Generation': '呈阅报告一键排版生成',
