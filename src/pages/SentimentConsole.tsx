...
import { ArrowLeft, Search, Filter, Heading, AlertTriangle, ChevronRight, BrainCircuit } from 'lucide-react';
    ...
    <div className="flex-1 flex flex-col bg-[#F4F6FA] overflow-hidden h-full">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="grid grid-cols-[1fr_520px] gap-5 items-start">
          ...
          {/* === LEFT · Global map with full MapContainer === */}
            ...
            <div className="h-[550px] bg-slate-50 border border-[#E2E7EF] rounded relative overflow-hidden" style={{ minHeight: '480px' }}>
              ...
              >
                ...
                {filtered.map((topic) => {
                  ...
                  const markerHtml = `
                    <div class="flex items-stretch bg-white border ${isSelected ? 'border-2 border-[#D8454C] ring-2 ring-red-500/20 shadow-md' : 'border-[#1A2330]'} w-[220px] h-[56px] overflow-hidden pointer-events-auto transition-all rounded-none shadow-sm hover:shadow-md hover:scale-[1.03] transform duration-150">
              ...
              {/* Absolute positioning overlays rendered cleanly above Leaflet */}
